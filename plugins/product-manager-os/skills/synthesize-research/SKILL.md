...
4. **Count frequency.** For each theme, count *distinct participants* who raised it (not total mentions — one person saying it five times is still n=1). Frequency is your floor, not your verdict.
...
8. **Rank insights** by frequency × impact, adjusted for confidence (how strong is the evidence, how big is n). State the small-sample caveat out loud wherever n is thin — "directional, n=4" is honest; presenting it as fact is not.
