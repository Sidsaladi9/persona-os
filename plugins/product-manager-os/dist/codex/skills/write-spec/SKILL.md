...
tier: guided
time: 45-90 min
inputs: the problem, who has it, and how you'd know it worked
outputs: projects/<project>/spec.md
---
...
**Go deeper (The Product Channel):** [Crafting Killer Problem Statements](https://sidsaladi.substack.com/p/week-29-a-step-by-step-guide-to-crafting)
