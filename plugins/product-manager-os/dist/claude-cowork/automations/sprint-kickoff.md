Use the `sprint-planning` skill to draft this sprint's plan.
...
Output the full Sprint Plan in the skill's format, then ask me what to adjust before I share it with the team.
