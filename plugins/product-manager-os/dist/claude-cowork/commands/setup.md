---
description: Set me up (or finish setting me up) — a 3-minute onboarding that fills your memory so I stop asking the basics. Re-run any time to fill only what's still missing; `/setup status` shows what I know.
---
